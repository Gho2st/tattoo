...
export default function KontaktPage() {
  return (
    <main className="min-h-screen bg-primary px-5 pt-28 pb-20 sm:px-8 sm:pt-32 lg:px-20 lg:pt-36 lg:pb-28">
      {/* Wspólny kontener — header i grid mają tę samą szerokość */}
      <div className="max-w-6xl mx-auto">
        ...
        {/* ── Grid: 5 / 7 — bardziej zrównoważony niż 1 / 2 ── */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-24">
          {/* ── Lewa kolumna: info + Instagram (sticky na desktopie) ── */}
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="border border-[#c9a96e]/12">
                {INFO.map(({ label, value, href }) => (
                  <div
                    key={label}
                    className="flex items-center justify-between gap-4 px-5 py-4 border-b border-[#c9a96e]/8 last:border-b-0"
                  >
                    <span className="text-xs tracking-widest uppercase text-[#c9a96e]/85 shrink-0">
                      {label}
                    </span>
                    {href ? (
                      <a
                        href={href}
                        className="text-sm font-light text-secondary hover:text-[#c9a96e] no-underline transition-colors duration-200 text-right"
                      >
                        {value}
                      </a>
                    ) : (
                      <span className="text-sm font-light text-secondary text-right">
                        {value}
                      </span>
                    )}
                  </div>
              ...
              >
                <div className="w-11 h-11 border border-[#c9a96e]/20 flex items-center justify-center shrink-0">
                  <svg
                    className="w-5 h-5 fill-[#c9a96e]/65"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="flex flex-col gap-1 min-w-0">
                  ...
                  <span className="text-sm font-light text-[#c9a96e]/55 group-hover:text-[#c9a96e] transition-colors duration-200 truncate">
                    @wolakurszula
                  </span>
                </div>
                <svg
                  className="ml-auto w-4 h-4 text-[#c9a96e]/25 group-hover:text-[#c9a96e]/60 group-hover:translate-x-0.5 transition-all duration-200 shrink-0"
                  viewBox="0 0 16 16"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1"
              ...
              <p className="text-xs font-light leading-relaxed text-[#f0ece3]/45 max-w-sm">
